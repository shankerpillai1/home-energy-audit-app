...
import pymongo
import gridfs
from backend.config.sql_database_config import run_sql_script
...
run_sql_script(SQL_URL, SQL_DATABASE_NAME, "backend/config/home_energy_audit_app_database.sql")
